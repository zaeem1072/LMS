    ...
    <div style={containerStyle}>
      ...
      <div style={cardStyle}>
        <div style={{ textAlign: "center", marginBottom: "30px" }}>
          ...
          <h2 style={{ margin: "0 0 10px", fontSize: "1.8rem", color: "#374151" }}>
            {getFullName()}
          </h2>
        ...
        {!isEditing ? (
          <div>
            ...
            <div style={infoRowStyle}>
              ...
              <span style={valueStyle}>{profile?.role === "teacher" ? "Teacher" : "Student"}</span>
            </div>
          ...
          <div>
            <h3 style={{ marginBottom: "20px", color: "#374151" }}>Edit Profile</h3>
